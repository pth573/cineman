...
<%--            if (lichchieuDAO328.isKhungGioTrong(phongchieu328.getId(), ngaygiobatdau, ngaygioketthuc)) {--%>
...
<%--<%--%>
<%--} else {--%>
<%--    // Thông báo lỗi nếu không lấy được thông tin phim hoặc phòng chiếu--%>
<%--%>--%>
<%--<p style="color: red;">Lỗi, không thể xác nhận lịch chiếu.</p>--%>
<%--<%--%>
<%--    }--%>
<%--} catch (Exception e) {--%>
<%--    // Hiển thị thông báo lỗi nếu có bất kỳ ngoại lệ nào xảy ra--%>
<%--%>--%>
<%--<p style="color: red;">Lỗi: <%= e.getMessage() %></p>--%>
<%--<%--%>
<%--    }--%>
<%--%>--%>
...
<%--        if (isSuccess) {--%>
<%--%>--%>
<%--<p style="color: green;">Đã thêm lịch thành công!</p>--%>
<%--<%--%>
<%--} else {--%>
<%--%>--%>
<%--<p style="color: red;">Lịch đã bị trùng.</p>--%>
<%--<%--%>
<%--        }--%>
<%--    }--%>
<%--%>--%>
